...
<html lang="en">
    <head>
        ...
        <link rel="icon" href="res/App.ico" />
        <link rel="apple-touch-icon" href="res/sharafi1.png" />
...
?>
    ...
    <body>
        <!-- news bar (set $s_news in script if needed) -->
        <?php if (!empty(
            /* insert on one line to avoid parser confusion */
            $s_news = isset($s_news) ? $s_news : 'بسم الله الرحمن الرحيم'
        ) ) : ?>
            <div class="news-bar"><span><?php echo $s_news; ?></span></div>
        <?php endif; ?>
        <div class="container app_page_title">
            <?php
            ...
            if (!empty($page_header_title))
            {
                ...
                <div class="div_btn_back">
                    <a href="landing.php" class="btn btn-lg btn-primary"><?php echo $lang["return_to_menu"] ?></a>
                </div>
                <?php
            }
            ...
            <img src="res/sharafi1.png" alt="Alsharafi Ex Logo" height="150" width="150"/><?php
